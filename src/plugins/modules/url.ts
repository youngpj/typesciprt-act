...
function deleteUrlQuery(queryKey:any) {
    var search = location.search;
    var resSearch = '';
    var queryArr:string [] = [].concat(queryKey);
...
function insertUrlQuery(params:any) {
    var search = location.search;
...
// 获取URL
function getQueryStrDecode(key:string, callback:any) {
    // 获取url上的query
